...
<ol>
  <li><strong>Clonar</strong> este repositorio<br>
    git clone https://github.com/giornn0/nc-challenge.git
  </li>
...
Cómo habrán notado el enpoint está en mayor médida escrito con valores de objetos generales para si en algún momento la ruta de auth por ejemplo cambia y la usamos en varios lugares solo deberíamos cambiarla en el enum/objeto que corresponda
